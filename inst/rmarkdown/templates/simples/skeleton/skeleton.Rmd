...
#
#                             E             N    
coords <- matrix(c(716726.00, 6846555.00, # V1
                   716784.00, 6846555.00, # V2
                   716782.00, 6846531.00, # V3
                   716719.00, 6846540.00, # V4
                   716726.00, 6846555.00),# V1
                 ncol = 2, byrow = TRUE)
#
#
# 2. Criação da feição  
...
attr <- data.frame(
  ...
  tipo = "terrestre",
  rip = NA,
  interessado = "Prefeitura Municipal de Laguna",
  area = st_area(spl),
  ...
  logradouro = "35",
  trecho = "00",
  aval = set_units(145.89, Reais/m^2)*st_area(spl),
  dataaval = as.Date("2020-05-29"),
  refaval = NA,
  onerosa = FALSE,
...
st_write(spl_df, "04972.003143.2012-89.geojson", delete_dsn = TRUE)
# Escrever em kml
#st_write(spl_df, "PMLaguna.kml", delete_dsn = TRUE)
```
